...
public class Magpie4
{
    ...
    /**
     * Take a statement with "I want to <something>." or "I want <something>" and transform it into
    ...
    private String getRandomResponse()
    {
        ...
        String[] randomResponses = {"Interesting, tell me more.", "Hmmm.", "Do you really think so?", "You don't say.", "Cool, can you elaborate?", "Ah, nice! Are you passionate about this?"};       
